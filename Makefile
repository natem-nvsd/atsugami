...
SRC=main.c about.c console.c file_count.c import_wizard.c import.c new_artist.c new_copyright.c new_character.c new_tag.c new_meta.c notebook.c list_tags.c
OBJ=${SRC:.c=.o}
